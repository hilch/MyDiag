...
#ifndef _LIBRARIES_20260706144249_
#define _LIBRARIES_20260706144249_
...
#endif
#ifdef _MYDIAG_EXPORT
	__asm__(".ascii \"plcexport \\\"MD_Dump\\\" FUB\\n\"");
	__asm__(".ascii \"plcexport \\\"MD_ascDT\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"MD_filenameDT\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"MD_LogWatchBOOL\\\" FUB\\n\"");
	__asm__(".ascii \"plcexport \\\"MD_LogWatch8Flags\\\" FUB\\n\"");
	__asm__(".ascii \"plcexport \\\"MD_LogWatchDINT\\\" FUB\\n\"");
	__asm__(".ascii \"plcexport \\\"MD_LogWatchSTRING\\\" FUB\\n\"");
	__asm__(".ascii \"plcexport \\\"MD_LogWrite\\\" FUB\\n\"");
	__asm__(".ascii \"plcexport \\\"MD_LimitFileNumber\\\" FUB\\n\"");
	__asm__(".ascii \"plcexport \\\"MD_Profiler\\\" FUB\\n\"");
#endif

__asm__(".previous");


#endif /* _LIBRARIES_20260706144249_ */
